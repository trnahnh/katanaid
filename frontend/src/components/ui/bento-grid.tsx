...
export const CARDS = [
  ...
  },
  {
    ...
    background: (
      <div className="absolute right-10 top-10 w-[70%] origin-top translate-x-0 border border-border rounded-lg transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-4 bg-background/50">
  ...
  },
  {
    ...
    background: (
      <div className="absolute right-10 top-10 w-[80%] origin-top border border-border rounded-lg transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:scale-105 p-4 bg-background/50">
        ...
        <div className="mt-3 flex items-center gap-2 text-xs">
          ...
          <span className="text-muted-foreground">3 suspicious phrases detected</span>
        </div>
      </div>
    ),
  },
  {
    ...
    cta: "Get API key",
    background: (
      <div className="absolute right-4 top-10 left-4 origin-top rounded-md border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:scale-105 p-3 bg-background/80 font-mono text-xs">
        <div className="text-muted-foreground">// Verify content in one call</div>
        <div className="mt-1">
          <span className="text-purple-400">const</span> <span className="text-blue-300">result</span> <span className="text-muted-foreground">=</span> <span className="text-purple-400">await</span> <span className="text-yellow-300">katana</span>.<span className="text-blue-300">verify</span>({"{"}
        </div>
